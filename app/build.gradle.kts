...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BUILD_TIMESTAMP", "\"2026-08-31-0002\"")
...
dependencies {
    ...
    // Voice/Video Calling (Phase 2) — the community-maintained replacement for Google's own
    // discontinued org.webrtc:google-webrtc artifact (pulled from JCenter years ago); classes
    // still live under the same org.webrtc.* namespace, this just ships pre-compiled binaries.
    // See CALLING_PLAN.md §11 for the decision (confirmed on Maven Central, actively maintained,

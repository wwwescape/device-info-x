...
class CalendarRepository @Inject constructor(
            ...
            consoleApiCall {
                calendarApi.create(
                    CalendarEventCreateDto(
                        ...
                        cancelledClamped, cancellationReasonClamped, reminderMinutesBefore, intimacyDto,
    ...
    /** Images are downloaded eagerly (see [reconcileAttachments]), so "saving" one is just
     * copying the already-local file — mirrors `MessageRepository.saveImageToPrivateDownloads`
     * exactly. */
    suspend fun saveEventImageToPrivateDownloads(attachment: MessageAttachment): File =
    ...
    suspend fun saveEventVideoToPrivateDownloads(attachment: MessageAttachment): File {
    ...
    suspend fun saveEventDocumentToPrivateDownloads(attachment: MessageAttachment): File {

 ...
 * (e.g. Dangerous) — that sub-page's own [androidx.compose.material3.TopAppBar] title already
 ...
 * data" (in [DangerousSettingsScreen]) needs its own distinct copy that isn't per-section. */
@Composable

 ...
 * address/status display. Unpair and Change Server both moved out to [DangerousSettingsScreen]
...
/** [PairingSection] minus the Unpair row — Unpair now lives on [DangerousSettingsScreen] since it

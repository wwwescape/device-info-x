...
/** Dangerous: the two escalating account-wide destructive actions (Delete all data / Destroy all
 * data, unchanged from the original [DangerousSection]), plus Unpair and Change Server — both
...
fun DangerousSettingsScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.console_settings_section_dangerous)) },
                navigationIcon = {

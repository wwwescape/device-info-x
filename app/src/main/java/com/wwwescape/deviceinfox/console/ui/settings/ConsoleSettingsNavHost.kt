    ...
    NavHost(navController = navController, startDestination = SettingsDestination.Main.route) {
        composable(SettingsDestination.Main.route) {
            ConsoleSettingsMainScreen(
                ...
                onDangerousClick = { navController.navigate(SettingsDestination.Dangerous.route) },
        ...
        composable(SettingsDestination.Dangerous.route) {
            DangerousSettingsScreen(onBack = { navController.popBackStack() }, onLock = onLock, viewModel = viewModel)
        }

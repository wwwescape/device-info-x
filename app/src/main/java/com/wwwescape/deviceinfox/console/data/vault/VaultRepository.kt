...
class VaultRepository @Inject constructor(
                ...
                val item = consoleApiCall {
                    lockerApi.createItem(
                        LockerItemCreateDto(
                            ...
                            mediaId = asset.id,
                            albumId = null,
                            category = LockerCategoryDto.PHOTO,
                ...
                val item = consoleApiCall {
                    lockerApi.createItem(
                        LockerItemCreateDto(
                            ...
                            mediaId = videoAsset.id,
                            albumId = null,
                            category = LockerCategoryDto.VIDEO,
                            originalMessageId = originalMessageId,
                            originalEventId = originalEventId,
                            originalAttachmentMediaId = attachment.mediaId,
                        ),
                ...
                val item = consoleApiCall {
                    lockerApi.createItem(
                        LockerItemCreateDto(
                            ...
                            mediaId = asset.id,
                            albumId = null,
                            category = LockerCategoryDto.DOCUMENT,
                            originalMessageId = originalMessageId,
                            originalEventId = originalEventId,
                            originalAttachmentMediaId = attachment.mediaId,
                        ),
    ...
    suspend fun exportItem(item: VaultItem, destinationUri: Uri) {
        ...
        mediaStorage.exportToDocument(sourcePath, destinationUri)
    }

package com.wwwescape.deviceinfox.ui.theme
...
/**
 * Device Info X theme: uses Material You dynamic color on Android 12+ and falls back to either a
...
fun DeviceInfoXTheme(
    ...
    MaterialTheme(
        ...
        typography = DeviceInfoXTypography,
        shapes = DeviceInfoXShapes,
        content = content,
    )
}

/**
 * The same colorScheme resolution [DeviceInfoXTheme] uses, extracted as a plain function so
 ...
 */
fun resolveDeviceInfoXColorScheme(
    context: Context,
    darkTheme: Boolean,

...
import com.wwwescape.deviceinfox.ui.components.DetailHero
import com.wwwescape.deviceinfox.ui.components.DetailSection
import com.wwwescape.deviceinfox.ui.components.DetailStatRow
import com.wwwescape.deviceinfox.ui.theme.JetBrainsMonoFamily
import com.wwwescape.deviceinfox.util.formatSecurityPatchDate

@Composable
fun DeviceOsScreen(
    modifier: Modifier = Modifier,
    viewModel: DeviceOsViewModel = hiltViewModel(),
) {
...
private fun DeviceOsScreenContent(
    ...
    Column(
        ...
        DetailSection(
            ...
            rows = listOfNotNull(
                info.marketingName?.let {
                    { DetailStatRow(stringResource(R.string.stat_marketing_name), it) }
                },

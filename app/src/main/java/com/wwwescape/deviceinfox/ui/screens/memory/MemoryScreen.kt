...
import com.wwwescape.deviceinfox.data.memory.MemoryBreakdown
...
import com.wwwescape.deviceinfox.data.memory.RamInfo
import com.wwwescape.deviceinfox.data.memory.StorageHardwareInfo
import com.wwwescape.deviceinfox.data.memory.StorageVolumeInfo
...
import com.wwwescape.deviceinfox.ui.components.StatTile
...
fun MemoryScreen(
    ...
    val breakdown = remember { context.memoryRepositoryEntryPoint().readMemoryBreakdown() }
    val hardwareInfo = remember { context.memoryRepositoryEntryPoint().readStorageHardwareInfo() }

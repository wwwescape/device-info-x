...
import com.wwwescape.deviceinfox.data.display.CutoutInfo
...
import com.wwwescape.deviceinfox.util.resolutionTier
...
fun DisplayScreen(
    ...
    val cutoutInfo = remember(view) {
        view.context.displayRepositoryEntryPoint().cutoutInfo(ViewCompat.getRootWindowInsets(view))
    }

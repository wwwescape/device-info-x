package com.wwwescape.deviceinfox.data.sensors
...
class SensorsRepository @Inject constructor(
    ...
    fun readings(sensor: Sensor): Flow<SensorReading> = callbackFlow {
    ...
    fun defaultAccelerometer(): Sensor? {
...
interface SensorsRepositoryEntryPoint {
    fun sensorsRepository(): SensorsRepository
}

fun Context.sensorsRepositoryEntryPoint(): SensorsRepository =
    EntryPointAccessors.fromApplication(applicationContext, SensorsRepositoryEntryPoint::class.java)
        .sensorsRepository()

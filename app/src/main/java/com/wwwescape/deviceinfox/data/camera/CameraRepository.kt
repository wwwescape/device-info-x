package com.wwwescape.deviceinfox.data.camera
...
class CameraRepository @Inject constructor(
    ...
    fun listCameras(): List<CameraLensInfo> {
...
fun Context.cameraRepositoryEntryPoint(): CameraRepository =
    EntryPointAccessors.fromApplication(applicationContext, CameraRepositoryEntryPoint::class.java)
        .cameraRepository()

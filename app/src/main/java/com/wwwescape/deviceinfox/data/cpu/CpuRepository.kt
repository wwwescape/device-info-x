package com.wwwescape.deviceinfox.data.cpu
...
interface CpuRepositoryEntryPoint {
    fun cpuRepository(): CpuRepository
}

fun Context.cpuRepositoryEntryPoint(): CpuRepository =
    EntryPointAccessors.fromApplication(applicationContext, CpuRepositoryEntryPoint::class.java)
        .cpuRepository()

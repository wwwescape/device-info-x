...
class NetworkRepository @Inject constructor(
    ...
    fun networkChangeEvents(): Flow<Unit> = callbackFlow {
        val connectivityManager = context.getSystemService(ConnectivityManager::class.java)
    ...
    private fun readWifiState(context: Context, isConnectedByCapabilities: Boolean): WifiState {
        ...
        val ssid = if (isConnected && hasLocationPermission()) {
    ...
    private fun readCellularSims(context: Context): List<CellularState> {
        ...
        val hasPhonePermission = hasPhoneStatePermission()
    ...
    private fun readBluetoothState(context: Context): BluetoothState {
        ...
        val canReadPairedDevices = isEnabled && hasBluetoothConnectPermission()
...
interface NetworkRepositoryEntryPoint {
    fun networkRepository(): NetworkRepository
}

fun Context.networkRepositoryEntryPoint(): NetworkRepository =
    EntryPointAccessors.fromApplication(applicationContext, NetworkRepositoryEntryPoint::class.java)
        .networkRepository()

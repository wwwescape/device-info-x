 ...
 * "DEVICE OVERVIEW" badge — same padding, and labelSmall's 11sp/Medium (DeviceInfoXTypography). */
@Composable
    ...
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            Box(contentAlignment = Alignment.Center, modifier = GlanceModifier.size(ringSizeDp.dp)) {
                ...
                Text(
                    // labelLarge: 14sp, Medium weight (M3 baseline, unmodified by DeviceInfoXTypography).
                    text = percentText,

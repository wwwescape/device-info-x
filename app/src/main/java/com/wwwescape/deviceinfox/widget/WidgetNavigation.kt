...
/** Intent extra carrying the [com.wwwescape.deviceinfox.ui.navigation.Destination] route a widget
 * tap should open — read by `MainActivity` and consumed by `DeviceInfoXApp` to navigate there once. */
...
/** Reopens [DeviceInfoXWidgetConfigActivity] for an already-placed widget instance, so its
...
fun widgetConfigIntent(context: Context, appWidgetId: Int): Intent =
    Intent(context, DeviceInfoXWidgetConfigActivity::class.java).apply {

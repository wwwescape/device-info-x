...
import com.wwwescape.deviceinfox.ui.screens.settings.label
 ...
 * via `android:configure` in `device_info_x_widget_info.xml`), and reopened later by the widget's own
 ...
 */
@AndroidEntryPoint
class DeviceInfoXWidgetConfigActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(appWidgetId) {
                val glanceId = GlanceAppWidgetManager(this@DeviceInfoXWidgetConfigActivity).getGlanceIdBy(appWidgetId)
                val prefs = getAppWidgetState(this@DeviceInfoXWidgetConfigActivity, PreferencesGlanceStateDefinition, glanceId)
    ...
    private suspend fun saveAndFinish(appWidgetId: Int, mode: ThemeMode) {
        ...
        DeviceInfoXWidget().update(this, glanceId)
...
@Composable
private fun DeviceInfoXWidgetConfigScreen(
    selected: ThemeMode,
    confirmLabel: String,
